...
void AccelStepper::step1(long step) {
  ...
  setOutputPins(_direction ? 0b10
                           : 0b00); // Set direction first else get rogue pulses
...
void AccelStepper::setPinsInverted(bool directionInvert, bool stepInvert,
                                   bool enableInvert) {
...
void AccelStepper::setPinsInverted(bool pin1Invert, bool pin2Invert,
