...
const removeRelation = async (clientId: string, profile: UserProfile | null) => {
    try {
...
export {removeRelation, fetchRelation, sendRequest, refuseRequest, acceptRequest, fetchNotifications};