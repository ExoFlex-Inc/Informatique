...
export async function planInit() {
  try {
    ...
    const responseGetPlanning = await fetch("http://localhost:3001/api/supabase/get-plan", {
      method: "GET",
    });
...
export default function Planning() {
  ...
  const savePlanToSupabase = async (plan) => {
    try {
      ...
      const response = await fetch("http://localhost:3001/api/supabase/push-plan-supabase", {
        method: "POST",
        headers: {
