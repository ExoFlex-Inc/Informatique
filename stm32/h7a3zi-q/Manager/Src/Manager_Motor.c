...
void ManagerMotor_CalculateNextPositions()
{
	...
	{
		if (fabsf(motors[MMOT_MOTOR_1].motor.position - motors[MMOT_MOTOR_1].goalPosition) > POSITION_TOL && motors[MMOT_MOTOR_1].goalReady)
		{
			ManagerMotor_MotorIncrement(MMOT_MOTOR_1, ManagerMotor_GetMotorDirection(MMOT_MOTOR_1));
		}
		else
		{
