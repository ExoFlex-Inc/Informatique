...
#define PS_GPIO_DORSIFLEXION_UP   GPIOC
#define PS_GPIO_LEG_LEFT          GPIOC
#define PS_GPIO_EXTENSION_DOWN    GPIOC
#define PS_GPIO_EVERSION_LEFT     GPIOE
#define PS_GPIO_LEG_RIGHT         GPIOE
#define PS_GPIO_EVERSION_RIGHT    GPIOC
#define PS_GPIO_EXTENSION_UP      GPIOF
#define PS_GPIO_DORSIFLEXION_DOWN GPIOF

#define PS_PIN_DORSIFLEXION_UP   GPIO_PIN_8
#define PS_PIN_LEG_LEFT          GPIO_PIN_9
#define PS_PIN_EXTENSION_DOWN    GPIO_PIN_10
#define PS_PIN_EVERSION_LEFT     GPIO_PIN_3
#define PS_PIN_LEG_RIGHT         GPIO_PIN_6
#define PS_PIN_EVERSION_RIGHT    GPIO_PIN_11
#define PS_PIN_EXTENSION_UP      GPIO_PIN_8
#define PS_PIN_DORSIFLEXION_DOWN GPIO_PIN_7
