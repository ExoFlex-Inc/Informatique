...
#define PS_PIN_LEG_LEFT          GPIO_PIN_5
#define PS_PIN_EVERSION_RIGHT    GPIO_PIN_3
#define PS_PIN_LEG_RIGHT         GPIO_PIN_8
#define PS_PIN_EXTENSION_DOWN    GPIO_PIN_6
#define PS_PIN_EVERSION_LEFT     GPIO_PIN_7
#define PS_PIN_DORSIFLEXION_DOWN GPIO_PIN_10
#define PS_PIN_EXTENSION_UP      GPIO_PIN_9
#define PS_PIN_DORSIFLEXION_UP   GPIO_PIN_4
