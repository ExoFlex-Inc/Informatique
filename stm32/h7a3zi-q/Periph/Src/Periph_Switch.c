...
#define PS_PIN_EVERSION_RIGHT    GPIO_PIN_2  // 2
#define PS_PIN_EXTENSION_DOWN    GPIO_PIN_4  // 4
#define PS_PIN_LEG_LEFT          GPIO_PIN_5  // 5
#define PS_PIN_EXTENSION_UP      GPIO_PIN_8  // 8
#define PS_PIN_DORSIFLEXION_DOWN GPIO_PIN_3  // 3
#define PS_PIN_DORSIFLEXION_UP   GPIO_PIN_6  // 6
#define PS_PIN_EVERSION_LEFT     GPIO_PIN_7  // 7
#define PS_PIN_LEG_RIGHT         GPIO_PIN_9  // 9
=======
#define PS_GPIO_LEG_LEFT          GPIOD
#define PS_GPIO_EVERSION_RIGHT    GPIOE
#define PS_GPIO_LEG_RIGHT         GPIOE
#define PS_GPIO_EXTENSION_DOWN    GPIOF
#define PS_GPIO_EVERSION_LEFT     GPIOE
#define PS_GPIO_DORSIFLEXION_DOWN GPIOE
#define PS_GPIO_EXTENSION_UP      GPIOF
#define PS_GPIO_DORSIFLEXION_UP   GPIOF

#define PS_PIN_LEG_LEFT          GPIO_PIN_10  // 2
#define PS_PIN_EVERSION_RIGHT    GPIO_PIN_4  // 4
#define PS_PIN_LEG_RIGHT         GPIO_PIN_5  // 5
#define PS_PIN_EXTENSION_DOWN    GPIO_PIN_8  // 8
#define PS_PIN_EVERSION_LEFT     GPIO_PIN_3  // 3
#define PS_PIN_DORSIFLEXION_DOWN GPIO_PIN_6  // 6
#define PS_PIN_EXTENSION_UP      GPIO_PIN_7  // 7
#define PS_PIN_DORSIFLEXION_UP   GPIO_PIN_9  // 9
